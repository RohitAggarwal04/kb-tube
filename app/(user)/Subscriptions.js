...
function Subscriptions() {
   ...
   //    try {
   //       const response = await fetchAll('user/categoryWiseVideo', { 'categoryId': categoryId });
   ...
   const fetchVideo = async () => {
      try {
         ...
         const response = await fetchAll('user/subscriptions', { type: 1 });
         if (response.data && response.data.data) {
            setallVideo(response.data.data);
   ...
   const fetchVideop = async () => {
      try {
         ...
         const response = await fetchAll('user/subscriptions',{type: 2});
         if (response.data && response.data.data) {
      ...
      <>
         ...
         <div className="col-xxl-10 col-xl-9 col-lg-9">
            ...
            <div className='d-flex justify-content-between align-items-center px-1'>
                ...
                <Link href="/feed/channels" className='text-decoration-none'><strong>Manage</strong></Link>
            </div>
